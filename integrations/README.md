...
- **n8n / Make / Zapier workflow design:** webhook intake, normalization, AI enrichment, database update, and team notification.
...
3. Show `main.py` as the structured AI enrichment layer.
